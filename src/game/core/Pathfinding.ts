...
export class Pathfinding {
  ...
  // private readonly tileObjectToId: { [key: string]: number } = {};
  ...
  constructor(groundLayer: TileType[][], objectsLayer: (TileType | null)[][]) {
    ...
    // for (let i = 0; i < Object.values(TileTypes).length; i++) {
    //   const value = Object.values(TileTypes)[i];
    //   this.tileObjectToId[value.type] = i
    // }
